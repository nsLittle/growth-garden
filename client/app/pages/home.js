...
export default function Home() {
  ...
  return(
    ...
    <div className='grid'>
      <Link to='/' className='function-one'>Home</Link>
      <Link to='/login' className='function-two'>Login to Personal Garden</Link>
      <Link to='/plantseeds' className='function-three'>Plant Seeds</Link>
      <Link to='/growthmindset' className='function-four'>Growth Mind Set Reframer</Link>
    </div>
    </>
  )
}