...
export default function Home() {
  ...
  return(
    ...
    <div className='grid'>
      <Link href='/' className='function-one'>Home</Link>
      <Link href='/login' className='function-two'>Login to Personal Garden</Link>
      <Link href='/plantseeds' className='function-three'>Plant Seeds</Link>
      <Link href='/growthmindset' className='function-four'>Growth Mind Set Reframer</Link>
    </div>
    </>
  )
}